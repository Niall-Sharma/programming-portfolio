        ...
        <div className="group relative bg-stone-800 drop-shadow-xl  max-w-sm break-all">
                ...
                <div>
                        <div className= "bg-stone-800 justify-center flex flex-grow">  
                            <div className="p-10"> 
                                <div>
                                    <p className="text-purple-300 font-thin">{projecttype}</p>
                                </div>
                                ...
                                <Link href={pageLink} className="font-thin absolute left-0 bottom-0 ml-3 mb-5 outline outline-purple-500 rounded-sm p-2 text-purple-500 hover:bg-purple-500 hover:text-white hover:ease-in transition-all outline-1">
                                    Read More
                                </Link>
                            </div>
                        </div>
