...
export default function ProjectCard( {pageLink, projectName, imageLink, projectDescription}:any ) {
    return(
                ...
                <div>
                        <div className= "bg-stone-800 justify-center items-center flex flex-grow">  
                            <div className="p-10">                  
                                ...
                                <p className="text-center group-hover:opacity-100 group-hover:ease-in py-4">{projectDescription}</p>
