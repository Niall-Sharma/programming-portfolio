...
export default function Home() {
  return (
    <main className="scrollbar-hide">
      <div className="flex w-full relative items-center flex-wrap align-middle justify-center font-bold bg-center bg-cover to-black min-h-screen bg-gradient-radial from-purple-950 bg-fixed">
        <div className="">
